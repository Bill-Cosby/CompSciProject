...
actors.push_back(new player("human"));
    ...
    localItems.push_back(new clothing("platearmor",'P',5,5,0, "steel"));
    localItems.push_back(new clothing("plateboot",'B',5,5,0, "steel"));
    localItems.push_back(new clothing("plateboot",'B',5,5,0, "steel"));
    localItems.push_back(new clothing("plateleg",'B',5,5,0, "steel"));
    localItems.push_back(new clothing("plateleg",'B',5,5,0, "steel"));
    localItems.push_back(new clothing("platehelm",'H',6,6,0, "steel"));
    localItems.push_back(new clothing("platearm",'A',5,5,0, "steel"));
    localItems.push_back(new clothing("plateglove",'A',5,5,0, "steel"));
    localItems.push_back(new clothing("plateglove",'A',5,5,0, "steel"));
